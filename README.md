...
Ask a language model about something it never learned and it rarely says *"I don't know"* — it invents a fluent, plausible answer. This explainer makes the fix tangible: you **watch** the full RAG pipeline run, and you can play with every step.
...
- **Pick a question and tune top-k** — every passage is scored by cosine similarity and the best matches light up in both the plot and a ranked list.
